<div class="container">
	<br /><br />
	<div class="well">
		<center><h1>Motociklai</h1></center>
	</div>
	<div class="col-lg-6 col-md-6">
		<div class="table-responsive">
			...
			foreach($product as $row)
			{
				...
				margin-bottom:16px; height:350px" align="center">
				...
				echo '<h1>Turi puikią galimybę išbandyti dviratę transporto priemonę prisijungęs prie mūsų!</h1>';
			};
			?>
