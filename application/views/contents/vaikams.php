<div class="container">
    ...
    echo '  
                ...
                <a href="'.$row->product_id.'"><img src="' . base_url() . '/myassets/images/' . $row->product_image . '" class="img-thumbnail" height="2000" width="2000" /></a>
			...
			';}} else {
				echo '<h1>Prekes vaikams matysite prisijungę.</h1>';
			};
